...
(function( $ ){
  ...
  $.fn.vectorMap = function(options) {
    var map,
        methodName,
        event,
        map = this.children('.map').data('data');
...
};jvm.WorldMapObject = function(config){};

jvm.WorldMapObject.prototype.getLabelText = function(key){
  var text;
...
jvm.WorldMapObject.prototype.getLabelOffsets = function(key){
  var offsets;
 ...
 */
jvm.WorldMapObject.prototype.setHovered = function(isHovered){
 ...
 */
jvm.WorldMapObject.prototype.setSelected = function(isSelected){
...
jvm.WorldMapObject.prototype.setStyle = function(){
	this.shape.setStyle.apply(this.shape, arguments);
};

jvm.WorldMapObject.prototype.remove = function(){
  this.shape.remove();
  if (this.label) {
    this.label.remove();
  }
...
jvm.inherits(jvm.Region, jvm.WorldMapObject);
...
jvm.inherits(jvm.Marker, jvm.WorldMapObject);
 ...
 * @param {Object} params.main Config of the main map. See <a href="./jvm-map/">jvm.WorldMap</a> for more information.
...
jvm.MultiMap.prototype = {
  addMap: function(name, config){
    ...
    this.maps[name] = new jvm.WorldMap(jvm.$.extend(config, {container: cnt}));
