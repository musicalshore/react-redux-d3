    ...
    $.fn.easyPaginate = function(options) {
        ...
        this.each(function() {
            ...
            if (count > step) {
                ...
                if (options.nextprev) {                   
                    prev = $('<li class="' + options.previousBtn + ' prev"><a href="#" onclick="' + options.prevTrack + '; return false;">Prev</a></li>').appendTo(ol);                    
                ...
                if (options.numeric) {
                    for (var i = 1; i <= pages; i++) {
                        $('<li data-index="' + i + '"><a href="#" onclick="' + options.pgTrack + i + '; return false;">' + i + '</a></li>')
      						.appendTo(ol)
      						.click(function() {
      						    clicked = true;
                ...
                if (options.nextprev) {
                    next = $('<li class="' + options.nextBtn + ' next"><a href="#" onclick="' + options.nextTrack + '; return false;">Next</a></li>').appendTo(ol);                    
